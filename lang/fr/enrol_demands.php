...
$string['buttonstopreminders'] = "<a href='requests.php?nomail=1'>"
        . "<button>Ne plus m'envoyer de courriel pour ces demandes.</button></a>";
$string['buttonsendremindersagain'] = "<a href='requests.php?nomail=2'>"
        . "<button>Merci de me signaler ces demandes par courriel chaque lundi matin.</button></a>";
...
$string['headertableyourdemands'] = "<h2>Demandes que vous avez déposées</h2>
    <a href=/course/index.php><button type=button>Ajouter une demande</button></a>
    <br><br>";
